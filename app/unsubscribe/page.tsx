...
function UnsubscribeContent() {
  ...
  const t = {
    EN: {
      ...
      doneSub: "You won't receive any more emails from us. You can resubscribe anytime from the footer.",
    ...
    UA: {
      ...
      doneSub: 'Більше листів від нас не буде. Підписатись знову можна в будь-який момент через футер сайту.',
